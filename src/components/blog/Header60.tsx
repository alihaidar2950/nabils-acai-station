        ...
        <div className="grid grid-cols-1 items-start gap-x-12 gap-y-5 md:grid-cols-2 lg:gap-x-20 lg:gap-y-16">
          ...
          <div>
            <p className="text-text-alternative md:text-md">
              Discover the stories behind your favorite desserts, seasonal
              specials, and the craft that makes Urban Treats Collective worth
              the visit. Read tips, tricks, and tales from our kitchens across

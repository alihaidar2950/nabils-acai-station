      ...
      <div className="container">
        <div className="rb-12 mb-12 max-w-lg md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Have a question, collaboration idea, or feedback? We're here to
            listen.
          </p>
        </div>
        <div className="grid auto-cols-fr grid-cols-1 gap-x-12 gap-y-12 sm:grid-cols-2 md:gap-x-20 md:gap-y-16 lg:grid-cols-[0.5fr_1fr]">
          <div className="grid auto-cols-fr grid-cols-1 gap-x-4 gap-y-10">
            <div>
              ...
              <p className="mb-2">hello@urbantreats.com.au</p>
            ...
            <div>
              ...
              <p className="mb-2">(02) 9000 0000</p>
              <a className="underline" href="#">
                (02) 9000 0000
              </a>
            </div>
            <div>
              ...
              <p className="mb-2">
                Multiple locations across Sydney, Melbourne, and Perth
              </p>
